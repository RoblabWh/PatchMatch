...
public:
     ...
     * Save dense pcl (json)
     */
    void save_message_pack_dense(const std::string& path);

    /**
     * Save dense pcl (ply)
     */
    void save_point_cloud_dense(const std::string& path);

    /**
     * print map database as json formatted string
     */
    void print_message_pack();
