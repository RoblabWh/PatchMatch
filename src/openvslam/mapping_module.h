...
public:
    //! Constructor
    mapping_module(const std::shared_ptr<config>& cfg, data::map_database* map_db, const bool is_monocular);
    ...
    //! Set the depthmap module
    void set_depthmap_module(depthmap_computation_module* depthmap_compute);
